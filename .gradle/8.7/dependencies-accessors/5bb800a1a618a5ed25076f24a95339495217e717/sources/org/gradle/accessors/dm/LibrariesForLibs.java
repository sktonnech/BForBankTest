...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class TestLibraryAccessors extends SubDependencyFactory {
        private final TestKotlinxLibraryAccessors laccForTestKotlinxLibraryAccessors = new TestKotlinxLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>test.kotlinx</b>
         */
        public TestKotlinxLibraryAccessors getKotlinx() {
            return laccForTestKotlinxLibraryAccessors;
        }

    }

    public static class TestKotlinxLibraryAccessors extends SubDependencyFactory {
        private final TestKotlinxCoroutinesLibraryAccessors laccForTestKotlinxCoroutinesLibraryAccessors = new TestKotlinxCoroutinesLibraryAccessors(owner);

        public TestKotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>test.kotlinx.coroutines</b>
         */
        public TestKotlinxCoroutinesLibraryAccessors getCoroutines() {
            return laccForTestKotlinxCoroutinesLibraryAccessors;
        }

    }

    public static class TestKotlinxCoroutinesLibraryAccessors extends SubDependencyFactory {

        public TestKotlinxCoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getTest() {
            return create("test.kotlinx.coroutines.test");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinGradlePlugin</b> with value <b>2.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockkVersion</b> with value <b>1.13.13</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
